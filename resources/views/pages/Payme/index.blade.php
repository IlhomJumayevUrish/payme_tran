...
@section('content')
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">Payme</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header"><img src="{{ asset('assets/img/logo/payme_logo.png') }}" width="150"></h1>
    <!-- end page-header -->
    ...
    <div class="col-xl-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-plugins-16">
            ...
            <div class="panel-heading">
                ...
                <a href="{{ route('admin.payme.edit', ['psystem' => 'payme_user']) }}" class="btn btn-xs btn-primary mr-3">
            ...
            <div class="panel-body panel-form">
                <form class="form-horizontal form-bordered">
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label">API Endpoint URL</label>
                        <div class="col-lg-10">
                            <div class="input-group">
                                <div id="clipboard-default-user-point"class="form-control"> {{ url('/').'/api/payme/user' }} </div>
                                <span class="input-group-append">
										<button class="btn btn-inverse" type="button" data-clipboard-target="#clipboard-default-user-point"><i class="fa fa-clipboard"></i></button>
									</span>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-xl-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-plugins-16">
            ...
            <div class="panel-heading">
                ...
                <a href="{{ route('admin.payme.edit', ['psystem' => 'payme_order']) }}" class="btn btn-xs btn-primary mr-3">
                    <i class="fa fa-edit"></i> Редактировать
                </a>
                <div class="panel-heading-btn">
                    <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
            ...
            <div class="panel-body panel-form">
                <form class="form-horizontal form-bordered">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <div class="input-group">
                                <div id="clipboard-default-order-point" class="form-control">{{ url('/').'/api/payme/order' }}</div>
                                <span class="input-group-append">
										<button class="btn btn-inverse" type="button" data-clipboard-target="#clipboard-default-order-point"><i class="fa fa-clipboard"></i></button>
									</span>
                            </div>
                        </div>
                    </div>
